        ...
        dynamicutil = new DynamicUtil(mc);
         ...
         dynamicutil.getWidgetManager().loadWigdets(WIDGETS_FILE);
           ...
           if (!WIDGETS_FILE.exists()) {
            ...
            TextWidget textWidget = new TextWidget(MinecraftClient.getInstance(), "Biome: ", 0.04f, 0.02f,false,false,false,-1);
            dynamicutil.getWidgetManager().addWidget(textWidget);
            dynamicutil.getWidgetManager().addWidget(new TextWidget(mc, "Ping: ", 0.08f, 0.02f,false,false,false,-1));
            dynamicutil.getWidgetManager().addWidget(new TextWidget(mc, "BPS: ", 0.12f, 0.02f,false,false,false,-1));
            dynamicutil.getWidgetManager().addWidget(new TextWidget(mc, "Position: ", 0.16f, 0.02f,false,false,false,-1));
            dynamicutil.getWidgetManager().addWidget(new TextWidget(mc, "Day/Night: ", 0.16f, 0.02f,false,false,false,-1));
